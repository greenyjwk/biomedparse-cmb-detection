...
pretrained_pth = '/media/Datacenter_storage/Ji/BiomedParse/output/biomed_seg_lang_v1.yaml_conf~/run_34/00007452/default/model_state_dict.pt'
...
# === Main Loop ===
# All Sequence
img_root_path = "/media/Datacenter_storage/PublicDatasets/cerebral_microbleeds_VALDO/bias_field_correction_resampled_win_normalization_1021_min_max_3ch_stacked_yolo_cmbonly_GAN/images/val"
gt_root_path = "/media/Datacenter_storage/PublicDatasets/cerebral_microbleeds_VALDO/bias_field_correction_resampled_win_normalization_1021_min_max_3ch_stacked_yolo_cmbonly_GAN/labels/val"
...
for img_path in os.listdir(img_root_path):
    ...
    # gt_path = img_path.replace("_MRI_Brain.png", "").replace("-slice-", "_slice_") + '.txt'

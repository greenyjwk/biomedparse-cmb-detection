...
export WANDB_KEY=9c6b37144a6e987d5a78544624f679935e7d2e74 # Provide your wandb key here
CUDA_VISIBLE_DEVICES=1 mpirun -n 1 python entry.py train \
            ...
            # RESUME_FROM /media/Datacenter_storage/Ji/BiomedParse/output/biomed_seg_lang_v1.yaml_conf~/run_45/00025440/default/model_state_dict.pt
...
CUDA_VISIBLE_DEVICES=0 mpirun -n 1 python entry.py evaluate \
            ...
            RESUME_FROM /media/Datacenter_storage/Ji/BiomedParse/output/biomed_seg_lang_v1.yaml_conf~/allsequence/00012960/default/model_state_dict.pt \
            # RESUME_FROM /media/Datacenter_storage/Ji/BiomedParse/output/biomed_seg_lang_v1.yaml_conf~/t2s_only/00006480/default/model_state_dict.pt \

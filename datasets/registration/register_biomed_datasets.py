...
# datasets = ['valdo_biomedparse_cmbonly_allseq_gan']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_cmbonly_allsequence_modifiedPrompt']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_cmbonly_t2s_win_norm']
datasets = ["valdo_t2s_resampling"]
# datasets = ["valdo_t2s_resampling_GAN"]
# datasets = ["loss_dev"]
# datasets = ['valdo_biomedparse_cmbonly_t2sonly_gan']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_3slices']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_T2']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_csf_cmbonly']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_csf']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_csf_cmbonly_gan']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_cmbonly_t2sonly']   # provide name of the dataset under biomedparse_datasets
# datasets = ['valdo_biomedparse_all_sequence']   # provide name of the dataset under biomedparse_datasets
